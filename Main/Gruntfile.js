...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        //Fire up local server with livereload
        connect: {
            options: {
                port: 9000,
                ...
                options: {
                    middleware: function (connect) {
                        return [
                            ...
                            mountFolder(connect, settingsConfig.dist)
                        ];
                    }
                }
            }
    ...
    grunt.registerTask('scripts', ['jshint', 'copy:scriptLibs', 'rig', 'concat', 'uglify']);
    grunt.registerTask('styles', ['search:noExtend', 'sass', 'autoprefixer', 'cssmin', 'copy:fonts']);
